 ...
 */
public class CreateNewEncounter extends javax.swing.JFrame {

    Patient patient;
    String doctorid;
    /**
     * Creates new form CreateNewEncounter
     */
    public CreateNewEncounter() {
        initComponents();
    }

    public CreateNewEncounter(Patient patient, String s) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Encounter Date");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        Doctor doctor = DataStore.getInstance().getSystem().getDoctorDirectory().getDoctorIdToDoctor().get(this.doctorid);
        ...
        {
            encounter.setId(String.valueOf(1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CreateNewEncounter.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CreateNewEncounter().setVisible(true);
            }
        });
    }
